...
class CustomerSubmitTicketScreen extends StatefulWidget {
  final String initialType;

  const CustomerSubmitTicketScreen({super.key, required this.initialType});

  @override
  State<CustomerSubmitTicketScreen> createState() => _CustomerSubmitTicketScreenState();
}

class _CustomerSubmitTicketScreenState extends State<CustomerSubmitTicketScreen> {
