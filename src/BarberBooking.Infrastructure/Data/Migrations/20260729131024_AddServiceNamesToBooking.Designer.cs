...
namespace BarberBooking.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260729131024_AddServiceNamesToBooking")]
    partial class AddServiceNamesToBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BarberBooking.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BarberBooking.Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<Guid?>("NoShowBarberId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BarberBooking.Domain.Entities.EmployeeSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BarberBooking.Domain.Entities.EmployeeService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EmployeeId", "BarberServiceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BarberBooking.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("BookingBlockedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int>("DailyCancelCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BarberBooking.Domain.Entities.UserDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BarberBooking.Domain.Entities.SystemAlert", b =>
                {
                    b.HasOne("BarberBooking.Domain.Entities.User", "TargetUser")
                        .WithMany()
